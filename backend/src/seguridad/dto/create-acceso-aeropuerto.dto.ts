...
export class CreateAccesoAeropuertoDto {
  ...
  @ApiPropertyOptional({ description: 'Acceso activo', default: true })
  @IsOptional()
  @IsBoolean()
  activo?: boolean;

  @ApiPropertyOptional({ description: 'Puede cambiar aeropuerto de trabajo', default: true })
  @IsOptional()
  @IsBoolean()
